sap.ui.define([
	...
	"sap/ui/Device",
	"com/rmz/dpapproval/model/models",
	"com/rmz/dpapproval/controller/ListSelector",
	"com/rmz/dpapproval/controller/ErrorHandler",
	"com/rmz/dpapproval/model/formatter",
	"com/rmz/dpapproval/model/grouper"
], function (UIComponent, Device, models, ListSelector, ErrorHandler) {
	"use strict";

	return UIComponent.extend("com.rmz.dpapproval.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "com.rmz.dpapproval.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
				"libs": ["sap.ui.core", "sap.m", "sap.ushell", "sap.ui.layout", "sap.ui.table"]
			},
			"config": {
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "com.rmz.dpapproval.view",
